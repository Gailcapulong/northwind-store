import { pgTable, integer, uuid, boolean, jsonb, text, timestamp } from 'drizzle-orm/pg-core';
...
// cascade = "delete children when parent is deleted; restrict = " don't delete the parent if any child still references it."
